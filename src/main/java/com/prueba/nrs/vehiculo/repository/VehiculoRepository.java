...
public interface VehiculoRepository extends CrudRepository<tbl_vehiculo, Long>  {
    ...
    public int updateVehiculo(@Param("vmarca") String vmarca, @Param("vtipo_vehiculo") int vtipo_vehiculo, @Param("vcolor") String vcolor , @Param("vtipo_combustible") int vtipo_combustible );
}
